...
bool Bomberman::Player::Check_collision(Vector3 pos, int direction,
    Color *mapPixels, Texture2D cubicmap)
{
    Vector3 newPos = pos;
    ...
    if (newPos.x < -15 || newPos.z < -7 || newPos.x > 14 || newPos.z > 6)
        return (true);
    auto tmpz = newPos.z + 8.f;
    auto tmpx = newPos.x + 16.f;
    ...
    if ((mapPixels[y*cubicmap.width + x].r == 255) || (mapPixels[prey*cubicmap.width + prex].r == 255)) {
...
float Bomberman::Player::Player_animation(Color *mapPixels, Texture2D cubicmap)
{
    if (IsKeyDown(KEY_UP) && Check_collision(_pos1, 1, mapPixels, cubicmap)) {
    ...
    if (IsKeyDown(KEY_DOWN) && Check_collision(_pos1, 2, mapPixels, cubicmap)) {
        UpdateModelAnimation(_model, _anim[0],_animFrameCounter);
       _animFrameCounter++;
        if (_animFrameCounter >= _anim[0].frameCount)
           _animFrameCounter = 0;
    ...
    if (IsKeyDown(KEY_LEFT) && Check_collision(_pos1, 3, mapPixels, cubicmap)) {
        UpdateModelAnimation(_model, _anim[0],_animFrameCounter);
       _animFrameCounter++;
        if (_animFrameCounter >= _anim[0].frameCount)
           _animFrameCounter = 0;
    ...
    if (IsKeyDown(KEY_RIGHT) && Check_collision(_pos1, 4, mapPixels, cubicmap)) {
        UpdateModelAnimation(_model, _anim[0],_animFrameCounter);
       _animFrameCounter++;
        if (_animFrameCounter >= _anim[0].frameCount)
           _animFrameCounter = 0;
...
float Bomberman::Player::Player_move(Color *mapPixels, Texture2D cubicmap)
{
    if (IsKeyDown(KEY_W)  && Check_collision(_pos2, 1, mapPixels, cubicmap)) {
    ...
    if (IsKeyDown(KEY_S) && Check_collision(_pos2, 2, mapPixels, cubicmap)) {
        UpdateModelAnimation(_model2, _anim2[0],_animFrameCounter);
       _animFrameCounter++;
        if (_animFrameCounter >= _anim2[0].frameCount)
           _animFrameCounter = 0;
    ...
    if (IsKeyDown(KEY_Q) && Check_collision(_pos2, 3, mapPixels, cubicmap)) {
        UpdateModelAnimation(_model2, _anim2[0],_animFrameCounter);
       _animFrameCounter++;
        if (_animFrameCounter >= _anim2[0].frameCount)
           _animFrameCounter = 0;
    ...
    if (IsKeyDown(KEY_E) && Check_collision(_pos2, 4, mapPixels, cubicmap)) {
        UpdateModelAnimation(_model2, _anim2[0],_animFrameCounter);
       _animFrameCounter++;
        if (_animFrameCounter >= _anim2[0].frameCount)
           _animFrameCounter = 0;
